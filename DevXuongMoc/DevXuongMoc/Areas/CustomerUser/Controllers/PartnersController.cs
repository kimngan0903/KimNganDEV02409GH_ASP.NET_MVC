...
namespace DevXuongMoc.Areas.CustomerUser.Controllers
{
    ...
    public class PartnersController : Controller
    {
        ...
        // GET: CustomerUser/Partners
        public async Task<IActionResult> Index()
        {
            return View(await _context.Partners.ToListAsync());
        }

        // GET: CustomerUser/Partners/Details/5
        ...
        // GET: CustomerUser/Partners/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: CustomerUser/Partners/Create
        ...
        // GET: CustomerUser/Partners/Edit/5
        ...
        // POST: CustomerUser/Partners/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: CustomerUser/Partners/Delete/5
        ...
        // POST: CustomerUser/Partners/Delete/5
