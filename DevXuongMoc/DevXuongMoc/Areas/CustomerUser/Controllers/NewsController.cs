...
namespace DevXuongMoc.Areas.CustomerUser.Controllers
{
    ...
    public class NewsController : Controller
    {
        ...
        // GET: CustomerUser/News
        public async Task<IActionResult> Index()
        {
            return View(await _context.News.ToListAsync());
        }

        // GET: CustomerUser/News/Details/5
        ...
        // GET: CustomerUser/News/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: CustomerUser/News/Create
        ...
        // GET: CustomerUser/News/Delete/5
        ...
        // POST: CustomerUser/News/Delete/5
