...
namespace Lab07.Areas.Admin.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CategoryId,CategoryName,Status,CreatedDate,Image,Description")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CategoryId,CategoryName,Status,CreatedDate,Image,Description")] Category category)
        {
